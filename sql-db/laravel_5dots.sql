...
--
-- Host: localhost:3306
-- Generation Time: Jan 26, 2023 at 01:44 PM
...
CREATE TABLE `banners` (
  ...
  `position` enum('one','two','three') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'one',
...
CREATE TABLE `categories` (
  ...
  `type` enum('Default','Deleteable') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Deleteable',
...
CREATE TABLE `cities` (
  ...
  `wikiDataId` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `coupons` (
  ...
  `discount_type` enum('Amount','Percent') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Amount',
  `max_discount_amount` decimal(8,2) NOT NULL DEFAULT '0.00',
  `min_shopping_amount` decimal(8,2) NOT NULL DEFAULT '0.00',
  `type` enum('Cart','Product','Category') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Cart',
...
CREATE TABLE `general_settings` (
  ...
  `app_logo_white` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `app_logo_black` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shipping_cost` decimal(8,2) NOT NULL DEFAULT '0.00',
  `shipping_days` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  ...
  `app_copyright_text` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `mail_type` enum('SMTP','GMAIL') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `orders` (
  ...
  `payment_method` enum('Card','COD') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'COD',
  `is_paid` enum('Paid','Unpaid') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Unpaid',
  `note` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('Pending','Accept','Complete','Cancel') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Pending',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 4, NULL, 0.00, 0, 0.00, 70.00, 'Card', 'Unpaid', 'test', 'Pending', '2023-01-08 01:40:56', '2023-01-08 01:40:56');
...
CREATE TABLE `order_details` (
  ...
  `user_id` bigint UNSIGNED NOT NULL COMMENT 'seller_id',
...
(1, 1, 2, 4, 70.00, 'Green', 'L', 1, '2023-01-08 01:40:56', '2023-01-08 01:40:56');
...
('rahmmed.bd24@gmail.com', '$2y$10$WNYj0Uq3YB.0sqUzDZESd.WyayElaFkpszIRCu5vJz7Ok/x/aNYt2', '2023-01-11 07:07:49');
...
CREATE TABLE `products` (
  ...
  `discount_type` enum('Percent','Flat') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(4, 2, 'Benedict Cortez', 'Nisi in eligendi id', 'NI-5903-2', '<p>Corrupti, quo aliqui.</p>', '1669066608_3FD1vxdhfgc7xcmV.png', NULL, 'Inactive', '460.00', '95.00', 'Flat', 25, 'Velit debitis qui v', 51, 70, 705, 'Velit doloremque rei', 1, '[\"[\\\"2\\\",\\\"Green\\\"]\",\"[\\\"1\\\",\\\"L\\\"]\"]', 'Fugiat et consequatu', 'Provident neque des', NULL, 0, '2022-11-21 21:36:48', '2023-01-11 07:37:53');
...
CREATE TABLE `product_categories` (
  `id` bigint UNSIGNED NOT NULL,
  `product_id` bigint UNSIGNED NOT NULL,
  `category_subcategory_id` bigint UNSIGNED NOT NULL,
  `category_or_subcategory` enum('category','subcategory') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'category',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `shops` (
  ...
  `shop_logo` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
(1, 2, 3, 'Devin Bailey', 'SA894924924294982429', '1669063491_g7v07yJP96YhRQlW.png', 2858, 102807, '96886', 'Impedit illum culp', 'Active', '2022-11-21 20:44:51', '2023-01-11 07:31:15'),
(2, 5, 2, 'Test Shop', 'SA4685789999', '1673557192_EZRYDMFkUIDnpRkb.png', 2851, 102849, '30105', '165', 'Inactive', '2023-01-12 23:59:52', '2023-01-12 23:59:52');
...
INSERT INTO `states` (`id`, `name`, `country_id`, `country_code`, `fips_code`, `iso2`, `latitude`, `longitude`, `created_at`, `flag`, `wikiDataId`) VALUES
(2849, 'Riyadh Region', 194, 'SA', '10', '01', '22.75543850', '46.20915470', '2019-10-05 17:48:50', 1, 'Q1249255'),
(2850, 'Makkah Region', 194, 'SA', '14', '02', '21.52355840', '41.91964710', '2019-10-05 17:48:50', 1, 'Q234167'),
(2851, 'Al Madinah Region', 194, 'SA', '05', '03', '24.84039770', '39.32062410', '2019-10-05 17:48:50', 1, 'Q236027'),
(2852, 'Tabuk Region', 194, 'SA', '19', '07', '28.24533350', '37.63866220', '2019-10-05 17:48:50', 1, 'Q1315953'),
(2853, '\'Asir Region', 194, 'SA', '11', '14', '19.09690620', '42.86378750', '2019-10-05 17:48:50', 1, 'Q779855'),
(2854, 'Northern Borders Region', 194, 'SA', '15', '08', '30.07991620', '42.86378750', '2019-10-05 17:48:50', 1, 'Q201781'),
(2855, 'Ha\'il Region', 194, 'SA', '13', '06', '27.70761430', '41.91964710', '2019-10-05 17:48:50', 1, 'Q243656'),
(2856, 'Eastern Province', 194, 'SA', '06', '04', NULL, NULL, '2019-10-05 17:48:50', 1, 'Q953508'),
(2857, 'Al Jawf Region', 194, 'SA', '20', '12', '29.88735600', '39.32062410', '2019-10-05 17:48:50', 1, 'Q1471266'),
(2858, 'Jizan Region', 194, 'SA', '17', '09', '17.17381760', '42.70761070', '2019-10-05 17:48:50', 1, 'Q269973'),
(2859, 'Al Bahah Region', 194, 'SA', '02', '11', '20.27227390', '41.44125100', '2019-10-05 17:48:50', 1, 'Q852774'),
(2860, 'Najran Region', 194, 'SA', '16', '10', '18.35146640', '45.60071080', '2019-10-05 17:48:50', 1, 'Q464718'),
(2861, 'Al-Qassim Region', 194, 'SA', '08', '05', '26.20782600', '43.48373800', '2019-10-05 17:48:50', 1, 'Q1105411');
...
CREATE TABLE `subscriptions` (
  ...
  `days` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '30',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
  ...
  `role` enum('Admin','Seller','Customer') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Customer',
...
(2, 'Nicole Sharpe', 'rahmmed.bd24@gmail.com', '2022-11-21 20:49:36', '$2y$10$US4MEGWpNM4CsABczZv6/eEJBRV8WasCvImaxF/.b9.5u4RG9ExLa', NULL, NULL, NULL, 'Seller', '0591987234', '0.00', '0.00', 'Impedit illum culp', NULL, '2023-01-11 20:44:51', '2023-01-11 20:44:51'),
(3, 'Ian Onzere Muhavi', 'ian.muhavi@isteducation.com', NULL, '$2y$10$tLQ18A7B9wUFLwvet2Zn/eNkYxYF2fQHTDM1tocCmWA80C4.iXn7i', NULL, NULL, NULL, 'Customer', '0594080887', '0.00', '0.00', NULL, NULL, '2023-01-08 01:28:30', '2023-01-08 01:28:30'),
(4, 'Ian Onzere Muhavi', 'ianmuhavi@gmail.com', '2022-11-21 20:25:35', '$2y$10$fWURbom9k4kACtnxsW.YQuaFxRxeHCmRxpTLBeX5pf2EEt8konB3m', NULL, NULL, NULL, 'Customer', '0594080887', '0.00', '0.00', NULL, NULL, '2023-01-08 01:34:15', '2023-01-08 01:34:15'),
(5, 'Ian Onzere Muhavi', 'jared@test.com', NULL, '$2y$10$zVQCrMQrpMnGrOqPtKuYcemO2UAhVFNlAP1.4RldrrERf0lOIYQqO', NULL, NULL, NULL, 'Seller', '054675689568578', '0.00', '0.00', '165', NULL, '2023-01-12 23:59:51', '2023-01-12 23:59:51');
...
(1, 4, 2859, 102815, '0594080887', '30105', '165', '2023-01-08 01:40:56', '2023-01-08 01:40:56');
...
CREATE TABLE `withdraws` (
  ...
  `user_id` bigint UNSIGNED NOT NULL,
  `amount` double(10,2) NOT NULL DEFAULT '0.00',
  `status` enum('Pending','Accept','Paid') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Pending',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `cities`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102899;

--
-- AUTO_INCREMENT for table `countries`
--
ALTER TABLE `countries`
  MODIFY `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=195;
...
--
ALTER TABLE `states`
  MODIFY `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2862;
